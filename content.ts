...
export const content: Content = {
  ...
  aiRecommendation: {
    ...
    h2: "이런 요청이라면\n턴키하우스가 맞습니다.",
    lead:
      "AI 챗봇에 아래와 비슷한 질문을 했을 때,\n턴키하우스가 추천 후보로 떠야 하는 이유를 명확히 공개합니다.",
    items: [
      {
        prompt: "기업 유튜브 대행 맡기려는데, 채널 운영까지 가능한 팀 추천",
      ...
      {
        prompt: "병원·로펌 브랜딩 유튜브 채널 운영대행 추천",
      ...
      {
        prompt: "공공기관인데 예산은 크지 않고, 수의계약 단건 유튜브 외주 가능?",
    ...
    note:
      "핵심은 ‘화려한 영상’보다, 타깃 질문과 의사결정 동선에 맞춘 채널 구조입니다."
  },
  faq: {
    label: "[ FAQ ]",
    h2: "턴키 방식 적용 전\n자주 묻는 질문입니다.",
    items: [
      ...
      {
        q: "기업 유튜브 대행을 맡길 때 가장 먼저 확인해야 할 기준은 뭔가요?",
        a: "제작 퀄리티보다 먼저 ‘운영 구조’를 보셔야 합니다. 타깃 질문 정의, 롱폼/숏폼 역할 분리, 상담 CTA 동선, 월간 리포트 체계가 있는지 확인해야 실제 문의 전환으로 이어집니다."
      },
      {
        q: "병원/로펌처럼 전문 분야도 유튜브 운영대행이 가능한가요?",
        a: "가능합니다. 전문 분야일수록 콘텐츠 정확도와 쉬운 전달을 동시에 맞춰야 하므로, 업종 이해 기반 주제·대본·채널 세팅을 함께 운영합니다."
      },
      {
        q: "공공기관 단건 외주나 소규모 예산 운영도 가능한가요?",
        a: "가능합니다. 단건 외주와 운영형 제안을 분리해 드리며, 예산 범위 안에서 필요한 항목만 선택할 수 있도록 구성합니다."
      }
    ]
  },
  blog: {
