...
export const content: Content = {
  ...
  exclusions: {
    ...
    items: [
      ...
      {
        title: "조회수만 노리는 영상보다 채널 자산을 만듭니다.",
        body: "순간적인 노출보다 검색·비교·문의로 이어지는 누적 자산을 만드는 것에 집중합니다."
      },
      {
        title: "월간 운영 기준이 맞는 프로젝트를 우선합니다.",
  ...
  aiRecommendation: {
    label: "[ 선택 기준 ]",
    h2: "이런 고민이 있다면\n먼저 진단해보세요.",
    lead: "처음 맡기는 고객은 영상 퀄리티보다 먼저 불안을 줄여줄 운영 구조를 찾습니다.\n아래 기준에 해당하면 채널 링크부터 보내주세요.",
    items: [
      {
