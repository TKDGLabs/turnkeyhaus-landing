  ...
  return (
    <main className="mx-auto w-full max-w-4xl px-5 py-20 text-[#0B0F0E]">
      ...
      <div className="space-y-8 text-sm leading-relaxed text-black/80">
        <p>
          티케이디지랩스 주식회사(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.
        </p>

        <section>
          <h2 className="text-lg font-bold mb-2 text-[#0B0F0E]">제1조 (개인정보의 처리목적)</h2>
          ...
          <br />
          <p>
            <strong>1. 서비스 상담 신청 및 관리</strong><br />
            상담 신청 의사 확인, 본인 식별․인증, 각종 고지․통지, 고충 처리 등을 목적으로 개인정보를 처리합니다.
          </p>
          <br />
          <p>
            <strong>2. 재화 또는 서비스 제공</strong><br />
            서비스 제공, 계약서 및 청구서 발송, 브랜딩 콘텐츠 제작 및 채널 운영대행, 맞춤서비스 제공, 본인인증, 요금 결제(정기결제 포함) 및 정산 등을 목적으로 개인정보를 처리합니다.
          </p>
          <br />
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold mb-2 text-[#0B0F0E]">제2조 (개인정보의 처리 및 보유기간)</h2>
          <p>① 회사는 법령에 따른 개인정보 보유, 이용 기간 또는 정보주체로부터 개인정보를 수집 시에 동의 받은 개인정보 보유, 이용 기간 내에서 개인정보를 처리, 보유합니다.</p>
          <p>② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.</p>
          <br />
          <p>
            <strong>1. 서비스 상담 신청 및 관리 : 상담 종료 또는 사업 종료 시까지</strong><br />
            다만, 다음의 사유에 해당하는 경우에는 해당 사유 종료 시까지<br />
            1) 관계 법령 위반에 따른 수사, 조사 등이 진행 중인 경우에는 해당 수사, 조사 종료 시까지<br />
            2) 서비스 이용에 따른 채권 및 채무관계 잔존 시에는 해당 채권, 채무 관계 정산 시까지
          </p>
          <br />
          <p>
            <strong>2. 재화 또는 서비스 제공 : 재화․서비스 공급완료 및 요금결제․정산 완료 시까지</strong><br />
        ...
        <section>
          <h2 className="text-lg font-bold mb-2 text-[#0B0F0E]">제3조(이용자 및 법정대리인의 권리와 그 행사 방법)</h2>
          <p>① 정보주체는 회사에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.</p>
          <ul className="list-inside list-disc pl-2 mb-2">
            <li>개인정보 열람 요구</li>
        ...
        <section>
          <h2 className="text-lg font-bold mb-2 text-[#0B0F0E]">제4조(처리하는 개인정보 항목)</h2>
          <p>회사는 다음의 개인정보 항목을 처리하고 있습니다.</p>
          <br />
          <p>
            <strong>1. 서비스 상담 신청 및 관리</strong><br />
            - 필수항목 : 이름, 연락처, 이메일, 브랜드(상호)명<br />
            - 선택항목 : 현재 채널 링크
          </p>
          <br />
          <p>
            <strong>2. 재화 또는 서비스 제공 (정기결제 포함)</strong><br />
            - 필수항목 : 성명, 이메일, 전화번호, 결제정보(카드사명, 카드번호 일부 등 결제대행사가 제공하는 식별정보)
          </p>
          <br />
          <p>
            <strong>3. 자동 생성 및 수집 항목</strong><br />
        ...
        <section>
          <h2 className="text-lg font-bold mb-2 text-[#0B0F0E]">제5조(개인정보의 파기)</h2>
          ...
          <br />
          <p>
            <strong>1. 파기 절차</strong><br />
            회사는 파기 사유가 발생한 개인정보를 선정하고, 회사의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
          </p>
          <br />
          <p>
            <strong>2. 파기 방법</strong><br />
        ...
        <section>
          <h2 className="text-lg font-bold mb-2 text-[#0B0F0E]">제6조(개인정보의 안전성 확보조치)</h2>
          ...
          <ul className="list-inside pl-2">
            ...
            <li>3. 물리적 조치 : 업무 공간 및 자료보관실 등의 접근통제</li>
          </ul>
        </section>

        <section>
          <h2 className="text-lg font-bold mb-2 text-[#0B0F0E]">제7조(개인정보 자동 수집 장치의 설치∙운영 및 거부에 관한 사항)</h2>
        ...
        <section>
          <h2 className="text-lg font-bold mb-2 text-[#0B0F0E]">제8조(개인정보 보호책임자)</h2>
        ...
        <section>
          <h2 className="text-lg font-bold mb-2 text-[#0B0F0E]">제9조(권익침해 구제 방법)</h2>
        ...
        <section>
          <h2 className="text-lg font-bold mb-2 text-[#0B0F0E]">제10조(개인정보 처리방침 시행 및 변경)</h2>
          <p>이 개인정보 처리방침은 2026. 04. 24부터 적용됩니다.</p>
        </section>
      </div>
    </main>
  );
