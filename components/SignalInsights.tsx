        ...
        {items.map((item) => (
          ...
          >
            ...
            <div className="space-y-3.5">
              ...
              <h4 className="text-[22px] font-semibold leading-[1.38] tracking-tight text-[#0B0F0E] md:text-[26px]">
                {item.title}
              </h4>
              <p className="whitespace-pre-line break-keep text-[15px] leading-[1.9] text-black/72 md:text-base">
                {item.summary}
              </p>
              <p className="text-[13px] leading-[1.8] text-black/52 md:text-[14px]">{item.note}</p>
            </div>
          </article>
        ))}
      </div>
