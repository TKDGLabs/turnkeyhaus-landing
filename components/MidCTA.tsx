...
export default function MidCTA() {
  ...
  return (
    <div className="grid gap-6 rounded-[24px] border border-black/10 bg-white p-6 shadow-[0_10px_28px_rgba(11,15,14,0.04)] md:grid-cols-[1fr_auto] md:items-center md:p-8">
